...
class Usuarios_sistema_model extends CI_Model {
    ...
    function get_modulos() {
        $this->db->select('per_id as permisoid, `per_nombre` as permiso, `per_descripcion` as permisodesc, mod_id as moduloid, mod_nombre as modulo', FALSE);
    ...
    function get_roles() {
        $this->db->select('rol_id as rolid, rol_nombre as rol,rol_decripcion as des,
mod_id as moduloid, 
per_id as permisoid, 
