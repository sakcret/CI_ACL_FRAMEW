            ...
            <div class=" row-fluid">
                <div class="ui-widget-content ui-corner-all last boxshadowround span20 offset2">
                    <table width="100%" border="0">
                        ...
                        <tr>
                            <td colspan="2"><div style="margin-top: 10px; margin-left: 20px; color: #581313; font-size:25px; float: left;">Redireccionando en:&nbsp;&nbsp;<span style="float: none; font-weight: bolder;" id="redic_sec">5</span>&nbsp;&nbsp;Segundos</div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
